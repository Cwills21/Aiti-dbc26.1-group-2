  ...
  <div class="container marketing">
    ...
    @foreach ($cars as $car)
      <div class="col-lg-4">
        ...
        <img style="height:80px" src="{{asset($car->picture)}}" class="bd-placeholder-img rounded-circle" width="140" height="140" >
        <h2>{{$car->Carname}}</h2>
        <!-- <p>Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p> -->
        <p><a class="btn btn-secondary" href="#">Rent Me &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      @endforeach      
    </div><!-- /.row -->
