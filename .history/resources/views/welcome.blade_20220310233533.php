...
<div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('imagess/hero_1.jpg')">
        <!-- <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            @foreach ($cars as $car)
              ...
              @foreach ($cars as $car)
      <div class="col-lg-4">
        <img src="{{asset($car->picture)}}" class="bd-placeholder-img rounded" width="400" height="200" >
        <h2>{{$car->Carname}}</h2>
      <p><a class="btn btn-secondary" href="{{ route('register') }}">Rent Me &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      @endforeach  


              <div class="item-1">
                <a href="#"><img src="imagess/img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="item-1-contents">
                  <div class="text-center">
                  <h3><a href="#">Range Rover S64 Coupe</a></h3>
                  <div class="rating">
    ...
    <div class="site-section section-3" style="background-image: url('imagess/hero_2.jpg');">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="imagess/person_1.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="imagess/person_2.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="imagess/person_3.jpg" alt="Image" class="img-fluid mr-3">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="imagess/post_1.jpg" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="imagess/img_2.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="imagess/img_3.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
