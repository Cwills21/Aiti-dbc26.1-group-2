    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>                        
                  <a class="nav-link active" style="background:#17a2b8; color:white" aria-current="page" href="/">Home</a>
                </li>
                <li class="active">
                <a class="nav-link active" href="{{ route('showAllCars') }}">view Cars</a>
                </li>
                <li>
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-white" style="background:#17a2b8; color:white">Admin</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a style="background:#17a2b8; color:white" href="#">Add admin user</a>
                        </li>
                        <li>
                            <a style="background:#17a2b8; color:white" href="#">Send Email</a>
                        </li>
                        <li>
                            <a style="background:#17a2b8; color:white" href="#">Business</a>
                        </li>
                    </ul>
                </li>
            </ul>                    
