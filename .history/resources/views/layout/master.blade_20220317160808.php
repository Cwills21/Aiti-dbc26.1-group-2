    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-white" style="background:#17a2b8; color:white">About</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a style="background:#17a2b8; color:white" href="#">Location</a>
                        </li>
                        <li>
