...
Route::prefix('/rent')->group(function(){
    ...
    Route::put('/approve', [RentController::class, 'approveRent'])->name('approveRent')->middleware(['auth']);
    Route::put('/decline', [RentController::class, 'approveRent'])->name('approveRent')->middleware(['auth']);
    });
