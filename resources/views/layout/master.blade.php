               ...
               @if(Auth::User()->user_type == 'Admin')  
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="adminSubmenu">
                        ...
                        <li>
                            <a style="background:#17a2b8; color:white" href="{{route('showCustomers')}}">View Customers</a>
                        </li>
                        <li>
                            <a style="background:#17a2b8; color:white" href="{{route('PendingRent')}}">Rent Transactions</a>
                        </li>
